...
Situations where the data \textbf{does not} have a low-dimensional structure and cannot be effectively mapped onto a lower-dimensional space are illustrated in \Cref{fig:manifold_hypothesis_problems}.

...
It's based on consine similarity and can be used with a variety of text encoder as well as image encoders. % such as ResNet, ViT for image and BERT for text?
% the sequence lenght is 76 tokens.
